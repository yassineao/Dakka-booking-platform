...
export default function Hero() {
  ...
  <li>
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="mb-2 inline-block rounded bg-amber-600 px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
      aria-label="WhatsApp"
      title="WhatsApp"
    >
      <span className="[&>svg]:h-4 [&>svg]:w-4">
