...
type BookingType = 'Hochzeit' | 'Anders' | 'Workshop' | 'Private'| '';
...
export default function Navbar() {
  ...
  const [bookingType, setBookingType] = useState<BookingType>('Hochzeit');
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      placeholder="z.B. Straße 123, Stadt, Plz, Land"
                      className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-indigo-600"
                    />
                  </div>
